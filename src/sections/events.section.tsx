    ...
    <section id="about">
      <SectionContainer className="mb-12">
        <SectionBackground className="flex-col">
          <div id="event-text-container" className="mx-6 my-12 md:ml-14 md:my-14">
            <span className={subtitleStyle}>&gt; EVENT</span>
            <h1 className={titleStyle}>Protytype, Program, <span className="text-[#58A0D4]">Present</span> Your Next Grand Idea</h1>
            <p className={pStyle}>Brainstorming an idea, coding for a MVP, and presenting your final product, we at yuHacks aim to provide you with the best platform to make it happens.</p>
          </div>
